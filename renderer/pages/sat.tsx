  ...
  const impedanceBaseValue = (voltageBaseValue * voltageBaseValue) / potencialBaseValue || 0;
    ...
    if (potencialBaseValue > 0 && voltageBaseValue > 0 && impedanceBaseValue > 0) {
      ...
      for (let p = 0; p <= 100; p += deltaPValue) {
        ...
        const icc_radial_1aTop_pu: Complex = math.divide(1,math.add(za1,math.multiply(pValue,zLT))) as Complex
      
        const icc_radial_1bTop_pu: Complex = math.divide(1,math.add(zb1,math.multiply(1-pValue,zLT))) as unknown as Complex
                ...
                <table className='border border-collapse border-zinc-400 mt-4 w-full'>
                  <thead>
                    <tr className='bg-zinc-100'>
                      ...
                      <th className='border border-zinc-400 px-2 py-1'>Icc 3ɸ<sub>A→p</sub> (kA)</th>
                      <th className='border border-zinc-400 px-2 py-1'>Icc 3ɸ<sub>B→p</sub>(kA)</th>
                    </tr>
                  </thead>
                  <tbody>
